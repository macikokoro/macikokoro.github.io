...
<div class="container">
    ...
    <div class="row-fluid">
        <div class="span3">
            <?php echo $this->view()->render(array("element" => "admin-questions-left-menu"), array("controller" => 'add_question')); ?>
        </div>
        <div class="span9">
            <?php echo $this->view()->render(array('element' => 'admin-edit-question'), array('action' => $action, 'errors' => $errors, 'post' => $post)); ?>
        </div>
    </div>
