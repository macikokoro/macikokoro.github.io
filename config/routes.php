 ...
 */
Router::connect('/', 'Awesomesde::index');
 ...
 * a top-down fashion.
 */
Router::connect('/api/v1/{:controller}', array('http:method'=>'GET', 'action'=>'get'));
Router::connect('/api/v1/{:controller}/{:id}', array('http:method'=>'GET', 'action'=>'get'));
Router::connect('/api/v1/{:controller}/{:action}/{:id}', array('http:method'=>'GET'));
Router::connect('/api/v1/{:controller}/{:action}/{:args}', array('http:method'=>'GET'));

Router::connect('/api/v1/{:controller}/{:id}', array('http:method'=>'PUT', 'action'=>'put'));
Router::connect('/api/v1/{:controller}', array('http:method'=>'POST', 'action'=>'post'));
Router::connect('/api/v1/{:controller}/{:id}', array('http:method'=>'DELETE', 'action'=>'delete'));
