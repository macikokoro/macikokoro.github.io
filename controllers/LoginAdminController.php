...
class LoginAdminController extends \lithium\action\Controller
{
    ...
    public function doLogin()
    {
        ...
        if (isset($data['provider'])) {
            ...
            $profile = $authenticator->authenticate($provider);
            if ($profile) {
                $customer = Customers::newCustomerFromProviderIfNotExists($profile->getEmail(),
                    $profile->getUserName(),
